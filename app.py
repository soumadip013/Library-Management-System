...
if not st.session_state.logged_in:
    with st.container():
        ...
        with col2:
            st.subheader("📝 Sign Up")
            signup_username = st.text_input("New Userimport streamlit as st
import pandas as pd
import os
import json
import datetime
...
if "logged_in" not in st.session_state:
    st.session_state.logged_in = False
if "username" not in st.session_state:import streamlit as st
import pandas as pd
import os
import json
import datetime
...
if not st.session_state.logged_in:
    with st.container():
        ...
        with col2:
            ...
            role = st.selectbox("Role", ["student", "admin"])
            if st.button("Sign Up"):
                if signup(signup_username, signup_paimport streamlit as st
import pandas as pd
import os
import json
import datetime
